...
public final class delivery_005fboy_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("    \n");
      out.write("    \n");
      out.write("    <button class=\"btn btn-primary\" data-toggle=\"modal\" data-target=\"#addModal\">ADD DELIVERY BOY</button>\n");
      out.write("    \n");
      out.write("    <!-- Modal -->\n");
      ...
      out.write("                <h5 class=\"modal-title\" id=\"addModalLabel\">DELIVERY BOYS</h5>\n");
      ...
      out.write("                       \n");
      out.write("                            <label for=\"photo\">DELIVERY BOY-PHOTO<br>\n");
      ...
      out.write("                        <input type=\"number\" class=\"form-control\" id=\"number\"  placeholder=\"number\">\n");
      out.write("                    </div>  \n");
      out.write("                    <div class=\"form-group\">\n");
      out.write("                        <label for=\"email\">EMAIL</label>\n");
      out.write("                        <input type=\"email\" class=\"form-control\" id=\"email\" aria-describedby=\"emailHelp\" placeholder=\"emailid\">\n");
      out.write("                    </div> \n");
      out.write("                \n");
      out.write("                <div class=\"form-group\">\n");
      out.write("                        <label for=\"add\">ADDRESS</label>\n");
      out.write("                       \n");
      out.write("                        <input type=\"text\" class=\"form-control\" id=\"add1\"  placeholder=\"Shop Name\">\n");
      out.write("                        <input type=\"number\" class=\"form-control\" id=\"add2\"  placeholder=\"Shop No\">\n");
      out.write("                        <input type=\"text\" class=\"form-control\" id=\"add3\"  placeholder=\"Complex\">\n");
      out.write("                        <input type=\"text\" class=\"form-control\" id=\"add4\"  placeholder=\"Mall name\">\n");
      out.write("                        <input type=\"text\" class=\"form-control\" id=\"add5\"  placeholder=\"Steet name\">\n");
      out.write("                        <input type=\"number\" class=\"form-control\" id=\"add6\"  placeholder=\"Steet no\">\n");
      out.write("                        <input type=\"text\" class=\"form-control\" id=\"add7\"  placeholder=\"Society name\">\n");
      out.write("                        <input type=\"number\" class=\"form-control\" id=\"add8\"  placeholder=\"Society no\">\n");
      out.write("                        <input type=\"text\" class=\"form-control\" id=\"add9\"  placeholder=\"Landmark\">\n");
      out.write("                        <input type=\"text\" class=\"form-control\" id=\"add10\"  placeholder=\"road\">\n");
      out.write("                    </div>\n");
      out.write("                  \n");
      out.write("                  </div>\n");
      ...
      out.write("                <th>ADDRESS DETAIL</th>\n");
      out.write("            </tr>\n");
      out.write("        </thead>\n");
      out.write("       \n");
      out.write("        <tbody>\n");
      ...
      out.write("           var shop_name=$('#add1').val();\n");
      out.write("           var shop_no=$('#add2').val();\n");
      out.write("           var complex=$('#add3').val();\n");
      out.write("           var mall_name=$('#add4').val();\n");
      out.write("           var street_name=$('#add5').val();\n");
      out.write("           var street_no=$('#add6').val();\n");
      out.write("           var society_name=$('#add7').val();\n");
      out.write("           var society_no=$('#add8').val();\n");
      out.write("           var road=$('#add10').val();\n");
      out.write("           var landmark=$('#add9').val();\n");
      out.write("           \n");
      out.write("           \n");
      out.write("            alert(\"name=\"+name+\"&photo=\"+photo+\"&number=\"+number+\"&email=\"+email+\"&shop_name=\"+shop_name+\"&shop_no=\"+shop_no+\"&complex=\"+complex+\"&mall_name=\"+mall_name+\"&street_name=\"+street_name+\"&street_no=\"+street_no+\"&society_name=\"+society_name+\"&society_no=\"+society_no+\"&road=\"+road+\"&landmark=\"+landmark);\n");
      out.write("            $.ajax({            \n");
      out.write("               type: \"GET\",\n");
      out.write("               url: \"delivery_boy_insert_ajax.jsp\",\n");
      out.write("               data: \"name=\"+name+\"&photo=\"+photo+\"&number=\"+number+\"&email=\"+email+\"&shop_name=\"+shop_name+\"&shop_no=\"+shop_no+\"&complex=\"+complex+\"&mall_name=\"+mall_name+\"&street_name=\"+street_name+\"&street_no=\"+street_no+\"&society_name=\"+society_name+\"&society_no=\"+society_no+\"&road=\"+road+\"&landmark=\"+landmark,\n");
      ...
      out.write("            $.ajax({\n");
      out.write("               type: \"GET\",\n");
      out.write("               url: \"delivery_boy_select_ajax.jsp\",\n");
      out.write("               data: \"\",\n");
      out.write("               success: function (data) {\n");
      ...
      out.write("           var shop_name=$('#add1-'+id).val();\n");
      out.write("           var shop_no=$('#add2-'+id).val();\n");
      out.write("           var complex=$('#add3-'+id).val();\n");
      out.write("           var mall_name=$('#add4-'+id).val();\n");
      out.write("           var street_name=$('#add5-'+id).val();\n");
      out.write("           var street_no=$('#add6-'+id).val();\n");
      out.write("           var society_name=$('#add7-'+id).val();\n");
      out.write("           var society_no=$('#add8-'+id).val();\n");
      out.write("           var landmark=$('#add9-'+id).val();\n");
      out.write("           var road=$('#add10-'+id).val();\n");
      out.write("          \n");
      out.write("           \n");
      out.write("            alert(\"name=\"+name+\"&photo=\"+photo+\"&number=\"+number+\"&id=\"+id+\"&email=\"+email+\"&shop_name=\"+shop_name+\"&shop_no=\"+shop_no+\"&complex=\"+complex+\"&mall_name=\"+mall_name+\"&street_name=\"+street_name+\"&street_no=\"+street_no+\"&society_name=\"+society_name+\"&society_no=\"+society_no+\"&road=\"+road+\"&landmark=\"+landmark);\n");
      out.write("            $.ajax({\n");
      out.write("               type: \"GET\",\n");
      out.write("               url: \"delivery_boy_edit_ajax.jsp\",\n");
      out.write("               data: \"name=\"+name+\"&photo=\"+photo+\"&number=\"+number+\"&id=\"+id+\"&email=\"+email+\"&shop_name=\"+shop_name+\"&shop_no=\"+shop_no+\"&complex=\"+complex+\"&mall_name=\"+mall_name+\"&street_name=\"+street_name+\"&street_no=\"+street_no+\"&society_name=\"+society_name+\"&society_no=\"+society_no+\"&road=\"+road+\"&landmark=\"+landmark,\n");
      out.write("               success: function (data) {\n");
      ...
      out.write("               data: \"query=delete from delivery_boy where delivery_boy_id=\"+id+\"\",\n");
      out.write("               success: function (data) {\n");
      out.write("                        viewdata();\n");
      out.write("                    }\n");
      out.write("            });\n");
      ...
      out.write("            {\n");
      out.write("                alert();\n");
      out.write("                var img1=$('#photoupdate-'+updateid).attr('src');\n");
