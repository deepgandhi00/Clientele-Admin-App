...
public final class demo_005fajax_jsp extends org.apache.jasper.runtime.HttpJspBase
    ...
    try {
      ...
      if (_jspx_eval_c_forEach_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          out.write("\n");
          out.write("    <tr>\n");
          out.write("        <td><img id=\"image_display-");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${row.category_id}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("\" src=\"images/");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${row.category_image}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          ...
          out.write("</td>\n");
          out.write("        <td>");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${row.category_desc}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("</td>\n");
          out.write("\n");
          out.write("\n");
          out.write("\n");
          out.write("\n");
          out.write("        <td><button class=\"btn btn-warning\" data-toggle=\"modal\" data-target=\"#updateModal-");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${row.category_id}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          ...
          out.write("                            </div>\n");
          out.write("                            <form id=\"fileup-");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${row.category_id}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("\" method=\"post\" enctype=\"multipart/form-data\" action=\"images_upload.jsp\">\n");
          out.write("                                <div class=\"image-upload\">\n");
          out.write("                                    <label for=\"file-input\">\n");
          out.write("                                        <span class=\"fa fa-pencil\"></span>\n");
          out.write("                                        <input id=\"file-input\" type=\"file\" name=\"file-input\" onchange=\"edfilepreview(this,");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${row.category_id}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write(")\"/><br>\n");
          out.write("                                    </label>\n");
          out.write("\n");
          ...
          out.write("                            </div>\n");
          out.write("                            <div class=\"form-group\">\n");
          out.write("                                <label for=\"desc-");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${row.category_id}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("\">description</label>\n");
          out.write("                                <textarea class=\"form-control\" id=\"desc-");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${row.category_id}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write('"');
          out.write('>');
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${row.category_desc}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          ...
          out.write("                            <button type=\"submit\" onclick=\"edfileupload(");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${row.category_id}", java.lang.String.class, (PageContext)_jspx_page_context, null));
