...
public final class cities_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("    \n");
      out.write("    <button class=\"btn btn-primary\" data-toggle=\"modal\" data-target=\"#addModal\">ADD CITY</button>\n");
      out.write("    \n");
      out.write("    <!-- Modal -->\n");
      ...
      out.write("                <h5 class=\"modal-title\" id=\"addModalLabel\">ADD CITY</h5>\n");
      ...
      out.write("               data: \"query=insert into cities(city_name) values('\"+name+\"')\",\n");
      ...
      out.write("            $.ajax({\n");
      out.write("               type: \"GET\",\n");
      out.write("               url: \"cities_select_ajax.jsp\",\n");
      out.write("               data: \"\",\n");
      out.write("               success: function (data) {\n");
      ...
      out.write("               type: \"GET\",\n");
      out.write("               url: \"ajax_edit_button.jsp\",\n");
      out.write("               data: \"query=update cities set city_name='\"+name+\"' where city_id=\"+id+\"\",\n");
      out.write("               success: function (data) {\n");
      ...
      out.write("               type: \"GET\",\n");
      out.write("               url: \"ajax_edit_button.jsp\",\n");
      out.write("               data: \"query=delete from cities where city_id=\"+id+\"\",\n");
      out.write("               success: function (data) {\n");
      out.write("                        viewdata();\n");
      out.write("                    }\n");
      out.write("            });\n");
